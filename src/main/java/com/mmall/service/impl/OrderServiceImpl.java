...
public class OrderServiceImpl implements IOrderService {
    ...
    @Override
    public ServerResponse manageOrderSearch(Long orderNo, int pageNum, int pageSize) {
        PageHelper.startPage(pageNum, pageSize);
        Order order = orderMapper.selectByOrderNo(orderNo);
        if (order == null) {
            return ServerResponse.createByErrorMessage("没有该订单");
    ...
    public ServerResponse manageSendGoods(Long orderNo) {
        ...
        return ServerResponse.createByErrorMessage(Const.OrderStatusEnum.codeOf(order.getStatus()).getValue());
    }
    ...
    private ServerResponse getCartOrderItem(Integer userId, List<Cart> cartList) {
        ...
        for (Cart cartItem : cartList) {
            ...
            if (Const.ProductStatusEnum.ON_SALE.getCode() != product.getStatus()) {
                return ServerResponse.createByErrorMessage("商品" + product.getName() + "已下线");
            }
            //校验库存
